...
class GoNoGoActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var topText = findViewById(R.id.block_one) as TextView
        topText.setTextColor(getColor(R.color.black))
        instructionView.setBackgroundColor(getColor(R.color.black))
        recentScoreView.setBackgroundColor(getColor(R.color.black))
